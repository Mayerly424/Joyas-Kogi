...
const Main = () => {
    return (
        <main>
            <section class="dis-sto">
                ...
                <h1 class="heading-1">Servicios que ofrecemos</h1>
            </section>
            ...
            <div class="wrapper">
                <div class="box">
                    ...
                    <div class="back-face">
                        ...
                        <Link to="/Iniciar_Sesion" class="btn cta-btn cta-btn--edit">Agenda tu cita</Link>
                    </div>
                </div>
                <div class="box">
                    <div class="front-face">
                    ...
                    <div class="back-face">
                        ...
                        <Link to="/Iniciar_Sesión" class="btn cta-btn cta-btn--edit">Agenda tu cita</Link>
                    </div>
                </div>
                <div class="box">
                    <div class="front-face">
  ...
  <div className="slider">
    ...
    <img src="img/Slider9.png" alt="Imagen 4" />
            ...
            {/* Aquí van los productos con descuento */}
    ...
    <div className="card-product">
      ...
      <div className="content-card-product">
        ...
        <span className="add-cart">
          <Link to="/Carrito"><i className="fa-solid fas fa-shopping-cart" /></Link>
        </span>
